package com.huangzan.recyclerview.adapter;
...
import com.huangzan.recyclerview.R;
import com.huangzan.recyclerview.widget.ProgressWheel;
...
//                footerViewHolder.loadMore.setText(hint);
    ...
    //删除一条数据
    public  void deleteViewHolder(int position){
