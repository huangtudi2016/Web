    ...
    private void initTab() {
        ...
        switch (type) {
            case FAVORITES_ITEM_POPUPWINDOW:
                this.itemLongClickedPopWindowView = this.itemLongClickedPopWindowInflater.inflate(R.layout.list_item_longclicked_bookmarks, null);
                break;
            ...
            case HISTORY_VIEW_POPUPWINDOW:
                //对于历史内容弹出菜单，未作处理
                //this.favAndHisView = this.favAndHisInflater.inflate(R.layout.list_item_longclicked_bookmarks, null);
                break;
